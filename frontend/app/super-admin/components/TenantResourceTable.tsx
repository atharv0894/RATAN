        ...
        <table className="w-full text-sm text-left">
          <thead className="text-xs text-gray-400 uppercase bg-gray-800/50 border-b border-gray-800">
            <tr>
              ...
              <th className="px-6 py-4 font-medium">Total Documents</th>
          ...
          <tbody className="divide-y divide-gray-800">
            {data.map((tenant: any) => (
              <tr key={tenant.org_id} className="hover:bg-gray-800/30 transition-colors">
                ...
                <td className="px-6 py-4 text-gray-300">{tenant.active_users}</td>
                <td className="px-6 py-4 text-gray-300">{tenant.total_documents}</td>
